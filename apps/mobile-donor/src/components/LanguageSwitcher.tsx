 ...
 * to switch language before the donor is even authenticated. Opens a modal
 * list of flag+name options — same "easy to identify" requirement as web's
 * LanguageSwitcher, just native instead of a <select>.
 */
