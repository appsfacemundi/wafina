 ...
 * donation's full Photos array, opened by tapping the cover photo on a
 ...
 * check at the call site. Mirrors mobile-donor's identical component —
 * these two apps duplicate their own UI component sets rather than sharing
 * one (see the rest of src/components/), so this follows the same pattern.
 */
